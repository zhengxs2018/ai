...
export namespace DashscopeChat {
  ...
  export type ResponseFinish = 'stop' | 'length' | 'tool_calls' | 'content_filter' | 'function_call' | 'null';

  export interface ChatCompletionParametersParam extends DashscopeCompletions.CompletionParametersParam {
    /**
     * 指定可供模型调用的工具列表
     *
