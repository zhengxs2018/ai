...
export class Speech extends APIResource {
   ...
   */
  create(params: Speech.SpeechCreateParams, options?: RequestOptions): Promise<Response>;
  ...
  async create(
    ...
    // Note: pro 模型返回 json
    if (options?.__binaryResponse || resource.resposne_type === 'binary' || resource.resposne_type === 'stream')
      return response;
...
export namespace Speech {
  export type SpeechModel = (string & NonNullable<unknown>) | 'speech-01' | 'speech-01-pro';
